...
import hms.model.RoomDataManager; // [추가됨]
                ...
                try {
                    ...
                    switch (cmd) {
                        ...
                        case "RES_VALIDATE_CHECKIN":
                            ...
                            res = new NetworkMessage(vOk, "검증", null);
                            break;
                        case "AUTH_ROOM_SERVICE":
                            // 룸서비스 인증 (임시)
